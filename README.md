# mpowerup-pcf
MPowerUp Published PCF components
...
1. Download the managed solution [Solution.zip](https://github.com/MPowerUp/mpowerup-pcf/releases/download/v1.0.0/mpoweruppcf_1_0_0_1_managed.zip).
